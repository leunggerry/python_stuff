...
while True:
    ...
    #Parse the input, useing our vocabulary dictionary if necessary
    if len(direction) > 1:
        # for word in word_dictionary: #does it contain the word we know
        #     if word in direction:
        #         direction = word_dictionary[word]

        # rather than going through the dictionary, go through the user input
        #to reduce the time finding the correct word
